...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "universalConcept".
 */
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'universalConcept';
        value: number | UniversalConcept;
      } | null)
    | ({
        relationTo: 'product';
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "universalConcept_select".
 */
export interface UniversalConceptSelect<T extends boolean = true> {
  title?: T;
  images?:
    | T
    | {
